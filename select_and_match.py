...
def match_within(subset):
    """Matching ottimale ADHD<->controllo dentro un sottoinsieme (stesso sesso).
    Ritorna lista di (adhd_row, ctrl_row, delta_eta)."""
...
def main():
    ...
    # salva manifest appaiato: coppie consecutive, stesso pair_id
